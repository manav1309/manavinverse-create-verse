...
const Articles = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* ✅ SEO Meta Tags */}
      <Helmet>
        <title>Articles - ManavInVerse | In-depth Blogs & Insights</title>
        <meta
          name="description"
          content="Dive into in-depth articles from ManavInVerse covering mindfulness, creativity, digital communication, and more."
        />
        <meta name="author" content="ManavInVerse" />

        {/* Open Graph */}
        <meta property="og:title" content="Articles - ManavInVerse" />
        <meta
          property="og:description"
          content="Explore thoughtful articles from ManavInVerse - Insights into creativity, literature, and digital culture."
        />
        ...
        />
        <meta property="og:url" content="https://manavinverse.netlify.app/articles" />
      ...
      <section
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(61, 44, 44, 0.6), rgba(61, 44, 44, 0.6)), url(/lovable-uploads/624e3711-4077-4c8b-b7d1-0898e6be6549.png)',
        }}
      >
        <div className="text-center text-white z-10 max-w-4xl mx-auto px-4">
          ...
          <div className="flex items-center justify-center space-x-4 mb-4">
            ...
            <div className="text-left">
              <p className="text-cream text-lg font-bold">{authorInfo.name}</p>
              <p className="text-off-white/80 font-bold">Digital Storyteller & Writer</p>
            </div>
          </div>
          <p className="text-lg text-cream max-w-2xl mx-auto font-bold">
            In-depth explorations of topics that matter, from mindfulness and creativity to
