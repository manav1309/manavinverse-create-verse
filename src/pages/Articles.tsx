  ...
  return <div className="min-h-screen">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          {loading ? <div className="text-center">Loading...</div> : <div className="grid md:grid-cols-2 gap-8">
              {articles.map((post, index) => <motion.div key={post.id} initial={{
            opacity: 0,
            y: 30
          }} animate={{
            opacity: 1,
            ...
            delay: index * 0.1
                ...
                <div className="md:flex h-full">
                  <div className="md:w-2/5 relative">
                    <img src={post.image || '/placeholder.svg'} alt={post.title} className="w-full h-48 md:h-full object-cover group-hover:scale-105 transition-transform duration-300" />
