...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* ✅ SEO + Meta tags */}
      <Helmet>
        <title>ManavInVerse - Literary Universe</title>
        <meta
          name="description"
          content="Explore the literary universe of ManavInVerse - A collection of blogs, articles, and poetry"
        />
        <meta name="author" content="ManavInVerse" />

        {/* Open Graph (for social media) */}
        <meta property="og:title" content="ManavInVerse - Literary Universe" />
        <meta
        ...
        />
        <meta property="og:url" content="https://manavinverse.netlify.app/" />
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(61, 44, 44, 0.6), rgba(61, 44, 44, 0.6)), url(/lovable-uploads/337c3455-5c52-44dd-977e-caa0de49683b.png)",
        }}
      >
        <div className="text-center text-white z-10 max-w-4xl mx-auto px-4">
          <motion.h1
            ...
            className="text-5xl font-serif font-bold mb-6 text-justify md:text-7xl"
          >
          ...
          <motion.button
            ...
            className="bg-cream text-chocolate px-8 py-4 rounded-lg font-semibold text-lg hover:bg-off-white transition-colors duration-300 inline-flex items-center space-x-2 animate-pulse-scale"
          >
      ...
      <section
        id="featured"
        className="py-16 bg-gradient-to-br from-chocolate to-cream bg-[#73635d]"
      >
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(rgba(139, 69, 19, 0.4), rgba(139, 69, 19, 0.4)), url(/lovable-uploads/165c6897-3209-490b-9bdb-1b1578a0f739.png)",
            ...
            >
              ...
              <p className="text-cream mb-6 font-bold">
                Dive deep into thought-provoking contemporary insights
              </p>
              <Link
                to="/blogs"
                className="text-cream hover:text-cream/80 font-medium inline-flex items-center space-x-1"
              >
            ...
            <motion.div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(rgba(139, 69, 19, 0.4), rgba(139, 69, 19, 0.4)), url(/lovable-uploads/4f53a926-3f07-4dac-b1e2-eb33a40ea82f.png)",
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            >
              ...
              <h3 className="font-serif font-bold text-cream mb-4 text-3xl">
                Poetry
              </h3>
              <p className="text-cream mb-6 font-bold">
                Words are not mere verses; they are honey dripping from the ✒️
              </p>
              <Link
                to="/poems"
                className="text-cream hover:text-cream/80 font-medium inline-flex items-center space-x-1"
            ...
            <motion.div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(rgba(139, 69, 19, 0.4), rgba(139, 69, 19, 0.4)), url(/lovable-uploads/af9bcdee-1787-4a62-b339-d68c0cc2f092.png)",
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            >
