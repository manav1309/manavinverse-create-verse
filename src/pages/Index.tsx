                    ...
                    <div className="md:w-2/3 p-8">
                      <div className="mb-4">
                        <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${
                          post.type === 'blog' ? 'bg-blue-100 text-blue-800' :
                          post.type === 'article' ? 'bg-green-100 text-green-800' :
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <Link
                to="/blogs"
                className="text-chocolate hover:text-chocolate/80 font-medium inline-flex items-center space-x-1"
              >
