...
const Poems = () => {
  ...
  const openPoem = poem => setSelectedPoem(poem);
  const closePoem = () => setSelectedPoem(null);
    ...
    <div className="min-h-screen">
      ...
      >
        <div className="text-center text-white z-10 max-w-4xl mx-auto px-4">
          ...
          <p className="text-lg text-cream max-w-2xl mx-auto font-medium">
            The words are poured from the ink of the pen just like honey, and the poets are the weavers of the silky threads of feelings.
          </p>
        </div>
      </section>
              ...
              {poems.map((poem, index) => (
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(${poem.image || '/placeholder.svg'})`
                    }}
                  >
                    <div className="absolute inset-0 flex items-center justify-center text-center p-8">
                      <div>
                        <h3 className="text-2xl md:text-3xl font-serif font-bold mb-4 text-white drop-shadow-md group-hover:text-cream transition-colors">
                          {poem.title}
                        </h3>
                        <p className="text-lg italic leading-relaxed mb-4 text-white drop-shadow-sm">
                          {poem.preview}
                        </p>
                    ...
                    <div className="absolute bottom-4 right-4 bg-black/30 backdrop-blur-sm px-4 py-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          ...
          >
            <div className="p-8 md:p-12">
              <div className="text-center mb-8">
                <h1 className="text-3xl md:text-4xl font-serif font-bold text-white mb-4 drop-shadow-md">
                  {selectedPoem.title}
                </h1>
              ...
              <div className="max-w-2xl mx-auto">
                <div className="text-center font-serif text-lg leading-relaxed text-white whitespace-pre-line drop-shadow-sm">
