...
const Blogs = () => {
  ...
  const blogPosts = mockPosts.filter(post => post.type === 'blog');
      ...
      >
        <div className="text-center text-white z-10 max-w-4xl mx-auto px-4">
          ...
          <p className="text-lg text-cream max-w-2xl mx-auto">
            Exploring the intersection of technology, creativity, and human experience through thoughtful narratives and insights.
          </p>
        </div>
      </section>
